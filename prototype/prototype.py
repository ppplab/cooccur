#!/usr/bin/env python
"""
prototype.py: demonstrate the feasibility of privacy-preserving co-occurrence
analysis for classifying variants

This script will generate synthetic participant data according to an
evolutionary model, and then filter the co-occurrence pairs of variants from
that model through a privacy preserving data collection step.
...
def make_next_generation(population, references, databases, pop_size, p_mutation = 0.01):
    """
...
def main(args):
    ...
    # TODO: Construct a censored version of databases, duplicate population
    # members to fill out the number we need for co-occurrence analysis, and
    # try to process co-occurrence data in a privacy-preserving way.
